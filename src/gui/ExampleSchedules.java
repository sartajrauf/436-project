...
public class ExampleSchedules {
    ...
    static public void manuallyAddTimeBlocks(Schedule schedule) {
        ...
        schedule.addTimeBlockManually(
                new TimeBlock(new Task("Workout", 7, 3.0, startOfWeek.withHour(8), false),
        ...
        schedule.addTimeBlockManually(
                new TimeBlock(new Task("Coding", 3, 5.5, startOfWeek.plusDays(2).withHour(11).withMinute(30), false),
                        startOfWeek.plusDays(2).withHour(9).withMinute(0),
                        startOfWeek.plusDays(2).withHour(14).withMinute(30)));

        schedule.addTimeBlockManually(
                new TimeBlock(new Task("Emails", 1, 0.75, startOfWeek.plusDays(2).withHour(16).withMinute(45), false),
        ...
        schedule.addTimeBlockManually(
                new TimeBlock(new Task("Research", 6, 6.5, startOfWeek.plusDays(3).withHour(15).withMinute(30), false),
                        startOfWeek.plusDays(3).withHour(14).withMinute(0),
                        startOfWeek.plusDays(3).withHour(20).withMinute(30)));

        schedule.addTimeBlockManually(
                new TimeBlock(new Task("PrepWork", 4, 8.0, startOfWeek.plusDays(4).withHour(12), false),
                        startOfWeek.plusDays(4).withHour(10).withMinute(0),
                        startOfWeek.plusDays(4).withHour(18).withMinute(0)));

        schedule.addTimeBlockManually(
                new TimeBlock(new Task("Study", 5, 14.5, startOfWeek.plusDays(5).withHour(19).withMinute(30), false),
                        startOfWeek.plusDays(5).withHour(7).withMinute(0),
                        startOfWeek.plusDays(5).withHour(21).withMinute(30)));

        schedule.addTimeBlockManually(
                new TimeBlock(new Task("Groceries", 6, 1.0, startOfWeek.plusDays(6).withHour(12), false),
                        startOfWeek.plusDays(6).withHour(11).withMinute(0),
                        startOfWeek.plusDays(6).withHour(12).withMinute(0)));

        schedule.addTimeBlockManually(
                new TimeBlock(new Task("Relax", 10, 4.0, startOfWeek.plusDays(6).withHour(16), false),
